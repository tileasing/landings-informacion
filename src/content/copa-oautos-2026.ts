...
export const content: CopaOautos2026Content = {
  ...
  hero: {
    ...
    cta: {
      ...
      href: "/copa-oautos-2026/dashboard",
    },
    appStores: {
      playStore:
  ...
  about: {
    ...
    intro: "La Copa Oautos 2026 es una experiencia diseñada para que puedas:",
    activities: [
  ...
  howItWorks: {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Selecciona la selección que apoyarás durante el Mundial.",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        paragraphs: [
          "Son beneficios reales aplicables dentro de tu plan Oautos.",
        ],
      },
      {
