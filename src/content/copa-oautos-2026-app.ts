  ...
  quiniela: {
    ...
    phases: [
      ...
      },
      {
        ...
        status: 'locked',
        lockedMessage:
          'Disponible cuando se conozcan los finalistas.',
      },
    ],
    ...
    matches: [
      ...
      },
      {
        ...
        venue: 'Estadio de la Bahía de San Francisco (Área de la Bahía de San Francisco)',
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              ...
              { letter: 'C', text: 'Recibes acompañamiento durante el proceso' },
