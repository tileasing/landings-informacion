  ...
  quiniela: {
    ...
    matches: [
      ...
      },
      {
        ...
        phaseId: "grupos",
        group: "Grupo G",
        kickoff: "2026-06-15T13:00:00-06:00",
      ...
      },
      {
        ...
        phaseId: "grupos",
        group: "Grupo G",
        kickoff: "2026-06-26T21:00:00-06:00",
        venue: "Estadio de Seattle (Seattle)",
      ...
      // === Grupo H ===
      {
        ...
        phaseId: "grupos",
        group: "Grupo H",
        kickoff: "2026-06-15T16:00:00-06:00",
      ...
      },
      {
        ...
        phaseId: "grupos",
        group: "Grupo H",
        kickoff: "2026-06-15T10:00:00-06:00",
      ...
      },
      {
        ...
        phaseId: "grupos",
        group: "Grupo I",
        kickoff: "2026-06-22T18:00:00-06:00",
        venue: "Estadio Nueva York/Nueva Jersey (Nueva York)",
      ...
      },
      {
        ...
        phaseId: "grupos",
        group: "Grupo I",
        kickoff: "2026-06-22T15:00:00-06:00",
      ...
      },
      {
        ...
        phaseId: "grupos",
        group: "Grupo J",
        kickoff: "2026-06-16T22:00:00-06:00",
        venue:
      ...
      },
      {
        ...
        phaseId: "grupos",
        group: "Grupo J",
        kickoff: "2026-06-22T11:00:00-06:00",
      ...
      },
      {
        ...
        phaseId: "grupos",
        group: "Grupo J",
        kickoff: "2026-06-22T21:00:00-06:00",
        venue:
          "Estadio de la Bahía de San Francisco (Área de la Bahía de San Francisco)",
      ...
      },
      {
        ...
        phaseId: "grupos",
        group: "Grupo J",
        kickoff: "2026-06-27T20:00:00-06:00",
        venue: "Estadio Kansas City (Kansas City)",
      ...
      },
      {
        ...
        phaseId: "grupos",
        group: "Grupo K",
        kickoff: "2026-06-23T11:00:00-06:00",
        venue: "Estadio Houston (Houston)",
        teamA: { code: "pt", name: "Portugal" },
      ...
      },
      {
        ...
        phaseId: "grupos",
        group: "Grupo C",
        kickoff: "2026-06-19T18:30:00-06:00",
        venue: "Estadio Filadelfia (Filadelfia)",
        teamA: { code: "br", name: "Brasil" },
      ...
      },
      {
        ...
        phaseId: "grupos",
        group: "Grupo C",
        kickoff: "2026-06-24T16:00:00-06:00",
        venue: "Estadio Miami (Miami)",
        teamA: { code: "gb-sct", name: "Escocia" },
      ...
      },
      {
        ...
        phaseId: "grupos",
        group: "Grupo A",
        kickoff: "2026-06-18T10:00:00-06:00",
        venue: "Estadio Atlanta (Atlanta)",
      ...
      },
      {
        ...
        phaseId: "grupos",
        group: "Grupo L",
        kickoff: "2026-06-23T14:00:00-06:00",
        venue: "Estadio Boston (Boston)",
        teamA: { code: "gb-eng", name: "Inglaterra" },
      ...
      },
      {
        id: "m94-8a",
        phaseId: "octavos",
        kickoff: "2026-07-06T13:00:00-06:00",
        venue: "Estadio Dallas (Dallas)",
        teamA: { code: "pt", name: "Portugal" },
        teamB: { code: "es", name: "España" },
      },
      {
        id: "m95-8a",
        phaseId: "octavos",
        kickoff: "2026-07-07T10:00:00-06:00",
        venue: "Estadio Atlanta (Atlanta)",
        teamA: { code: "ar", name: "Argentina" },
        teamB: { code: "eg", name: "Egipto" },
      },
      {
        id: "m96-8a",
        phaseId: "octavos",
        kickoff: "2026-07-07T14:00:00-06:00",
        venue: "Estadio BC Place Vancouver (Vancouver)",
        teamA: { code: "ch", name: "Suiza" },
        teamB: { code: "co", name: "Colombia" },
      },
